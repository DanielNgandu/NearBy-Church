package com.danielngandu.nearbychurhces.utils;

/**
 * Created by Daniel Ng`andu 28/01/2020.
 */
...
public class GoogleApiUrl {
    ...
    public static final String API_KEY = "AIzaSyB9SXvLdo1FnKd8lcuVtvQaSx1tqqE_NFA";
